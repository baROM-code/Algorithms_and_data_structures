...
public class MyLinketList<T> implements Iterable<T> {
    private Node first;
    private Node last;
    private int size;
    ...
    private class ListIter implements ListIterator<T> {
        ...
        /*
          Сделал методы по аналогии с методами из Iter, но они работают неверно
          при выводе через
           while (listIterator.hasNext()){
            System.out.println(listIterator.next());
            }
          выводятся не все элементы !!! - todo нужно разабраться
         */
